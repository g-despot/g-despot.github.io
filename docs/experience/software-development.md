...
- **Client Library Development**: Developed a [Python object-graph mapper](https://github.com/memgraph/gqlalchemy) (OGM) package to simplify database operations and provide an intuitive interface for developers working with graph data models. (`Poetry`, `PyPI`)
